...
export class MCPServiceProvider implements vscode.TreeDataProvider<MCPServiceItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<MCPServiceItem | undefined | void> = new vscode.EventEmitter<MCPServiceItem | undefined | void>();
    readonly onDidChangeTreeData: vscode.Event<MCPServiceItem | undefined | void> = this._onDidChangeTreeData.event;
