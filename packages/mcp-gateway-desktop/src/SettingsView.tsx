      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3 max-w-md">
            ...
            <Select value={localConfig.browser} onValueChange={updateGlobalBrowser}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      <Card className="flex flex-col min-h-[400px]">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Customize the list of AI clients available in the quick launch menu.
            </CardDescription>
          </div>
            ...
            <ScrollArea className="h-[300px]">
              <div className="space-y-2 pr-4">
                {localConfig.aiSites.map((site, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-12 gap-4 items-center p-2 bg-muted/20 rounded-md border"
                  >
